<template>
  <div class="dashboard-container">
    ...
    <nav class="sidebar" :class="{ 'sidebar-collapsed': isSidebarCollapsed }">
      ...
      <div class="nav-menu">
        <router-link :to="{name: 'dashboard'}" class="nav-item" :class="{ 'active-link': activeLink === 'dashboard' }" @click="setActiveLink('dashboard')">
        ...
        <router-link :to="{ name: 'transaction'}" class="nav-item" :class="{ 'active-link': activeLink === 'transaction' }" @click="setActiveLink('transaction')">
          <svg class="nav-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M9 11H15M9 15H15M17 21H7C5.89543 21 5 20.1046 5 19V5C5 3.89543 5.89543 3 7 3H12.5858C12.851 3 13.1054 3.10536 13.2929 3.29289L19.7071 9.70711C19.8946 9.89464 20 10.149 20 10.4142V19C20 20.1046 19.1046 21 18 21H17Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>
          <span v-if="!isSidebarCollapsed">Transactions</span>
        </router-link>
        <router-link :to="{name: 'alertes'}" class="nav-item" :class="{ 'active-link': activeLink === 'alertes' }" @click="setActiveLink('alertes')">
          <svg class="nav-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <router-link :to="{name: 'rapports'}" class="nav-item" :class="{ 'active-link': activeLink === 'rapports' }" @click="setActiveLink('rapports')">
          <svg class="nav-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="nav-bottom">
        <router-link :to="{ name: 'login' }" class="nav-item logout">
          <svg class="nav-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <main class="main-content" :class="{ 'main-content-expanded': isSidebarCollapsed }">
      ...
      <div v-if="showUserInfo" class="user-info-modal">
        <div class="user-info-content">
          ...
          <p><strong>Nom:</strong> OUEDRAOGO</p>
          <p><strong>Prénom:</strong> Judith</p>
          <p><strong>Nom d'organisation:</strong> orange</p>
          <p><strong>Type d'organisation:</strong> Operateur mobile</p>
        </div>
      </div>
      <router-view />
    </main>
