<template>
  <div class="dashboard-container">
    ...
    <nav class="sidebar" :class="{ 'sidebar-collapsed': isSidebarCollapsed }">
      ...
      <div class="nav-menu">
    <router-link :to="{name: 'dashboard'}" class="nav-item active">
    ...
    <router-link :to="{name: 'alertes'}" class="nav-item">
      <svg class="nav-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <router-link :to="{name: 'rapports'}" class="nav-item">
      <svg class="nav-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <router-link :to="{name: 'parametres'}" class="nav-item">
      <svg class="nav-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
